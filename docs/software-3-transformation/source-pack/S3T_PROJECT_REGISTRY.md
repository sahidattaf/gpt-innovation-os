# S3T Project Registry

| Project | Adapter state | Current permitted relationship | System of record | Next controlled decision |
|---|---|---|---|---|
...
| Kai Kòrsou | Not connected | No new authority | project-controlled records | separate owner gate |

...
## Precedence
The canonical Software 3.0 prompt and approved owner gates override examples in this pack. Project-specific verified evidence overrides generic adapter descriptions. If two controlled sources conflict, stop and request an owner decision.

## Update process
Change via feature branch and pull request; record material decisions in Notion; update version/date; rerun CI; never treat an unmerged draft as production authority.
